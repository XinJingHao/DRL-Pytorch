...
# https://github.com/thu-ml/tianshou/blob/df35718992824287182d12811a138beeae6f0571/examples/atari/atari_wrapper.py
...
def make_env_tianshou(
    ...
    :param bool render: render the game or not.
...
class NoopResetEnv(gym.Wrapper):
    ...
    def reset(self):
        ...
        # noops = self.unwrapped.np_random.integers(1, self.noop_max + 1)  # SB3
